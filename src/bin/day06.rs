...
pub fn main() {
    ...
    let start_position = matrix.iter().flatten().enumerate().find(|(_, x)| x == &&'^');
    ...
    for position in path {
        ...
        if runs_loops(&matrix, start_position, (position.0, position.1, Direction::Up)) {
            loops.push(position);
        }
    }
    // for (i, y) in matrix.iter().enumerate() {
    //     for (j, x) in y.iter().enumerate() {
    //         if x == &'#' || x == &'^' {
    //             continue
    //         }
    //
    //         if runs_loops(&matrix, start_position, (j, i, Direction::Up)) {
    //             loops.push((j, i));
    //         }
    //     }
    // }
    ...
    // for (i, y) in matrix.iter().enumerate() {
    //     for (j, x) in y.iter().enumerate() {
    //         if loops.contains(&(j, i)) {
    //             print!("O");
    //         } else if path.iter().any(|(x, y)| (x, y) == (&j, &i)) {
    //             print!("X");
    //         } else {
    //             print!("{}", x);
    //         }
